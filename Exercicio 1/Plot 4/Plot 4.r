...
plot(Datetime2, xlab = "", subData2$Global_active_power, ylab="Global active power",
     type="l")

plot(Datetime2, xlab = "datetime", subData2$Voltage, ylab = "Voltage", type="l")
...
plot(Datetime2, xlab = "datetime", subData2$Global_reactive_power, 
